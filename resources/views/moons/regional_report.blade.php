		...
		<h1 class="page-header">
			...
			<div class="pull-right">
				<ol class="breadcrumb">
					...
					<li class="active">2020 Regional Report</li>
				</ol>
			</div>
...
<div class="col-md-12">
	<div class="panel panel-default regional-report-chart">
		...
		<div class="panel-heading">
			2020 Regional Report - Goo per Region.
...
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-heading">2020 Regional Report</div>
			...
			<div class="table-responsive top-border-table" id="location-table-wrapper">
				...
				<table class="table" id="regional_stats">
					...
					<tbody>
						...
						<tr>
							<td style="vertical-align: middle"><a href="{{ route('moons.regional_view', $region->moon_region_id )}}">{!! $region->moon_region_name !!}</a></td>
