...
return [
    ...
    */
    ...
    'url' => env('APP_URL', ($variables && array_key_exists('APP_URL', $variables)) ? $variables['APP_URL'] : 'https://scouts.scopeh.co.uk'),
    ...
    */
    ...
    'log' => env('APP_LOG', ($variables && array_key_exists('APP_LOG', $variables)) ? $variables['APP_LOG'] : 'daily'),
    ...
    */
    ...
    'providers' => [
        ...
        Vanguard\Providers\HorizonServiceProvider::class,
