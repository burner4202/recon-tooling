...
@section('page-title', 'Scout Tracking')
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">
			All Active Scout Characters
			<small> - location / ship / online.</small>
			<div class="pull-right">
				<ol class="breadcrumb">
					<li><a href="{{ route('dashboard') }}">@lang('app.home')</a></li>
					<li class="active">Scout Tracking</li>
				</ol>
			</div>
...
<div class="row tab-search">
	<div class="col-md-2">
		<a href="{{ route('route.update_scouts') }}" class="btn btn-primary active" title="Click here to update all Scouts Characters" id="add-system">
		...
		<div class="col-md-2">
			<div class="input-group custom-search-form">
				...
				<span class="input-group-btn">
					...
					<a href="{{ route('route.tracking') }}" class="btn btn-danger" type="button" >
