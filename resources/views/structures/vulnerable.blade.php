...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">
			...
			<small> - are due to become vulnerable.</small>
			<div class="pull-right">
				<ol class="breadcrumb">
					<li><a href="{{ route('dashboard') }}">@lang('app.home')</a></li>
					<li><a href="#">Vulnerable Structures</a></li>
				</ol>
			</div>
...
<div class="row tab-search">
	...
	<form method="GET" action="" accept-charset="UTF-8" id="structures-form">
		<div class="col-md-2">
			...
			<div class="input-group custom-search-form">
				...
				<span class="input-group-btn">
					...
					@if (
						...
						<a href="{{ route('structures.vulnerable') }}" class="btn btn-danger" type="button" >
			...
			<div class="col-md-1">
				Vulnerable Day
				{!! Form::select('vulnerable', $vulnerable, Input::get('vulnerable'), ['id' => 'vulnerable', 'class' => 'form-control']) !!}
			</div>
			...
			<div class="table-responsive top-border-table" id="srp-table-wrapper">
				...
				<table class="table" id="structures">
					<thead>
						...
						<th> @sortablelink('str_vul_day', 'Vulnerable Day')</th>
						<th> @sortablelink('str_vul_hour', 'Vulnerable Hour')</th>
						<th> Vulnerable Window</th>
					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle"><a href="{{ route('alliance.view', $structure->str_owner_alliance_id )}}"><img class="img-circle" src="https://imageserver.eveonline.com/Alliance/{{ $structure->str_owner_alliance_id }}_32.png">&nbsp;{{ $structure->str_owner_alliance_name }}</a>
								<td style="vertical-align: middle">{{ $structure->str_vul_day }}</td>
								<td style="vertical-align: middle">{{ $structure->str_vul_hour }}</td>
								<td style="vertical-align: middle">{{ \Carbon\Carbon::parse($structure->str_vul_hour)->subHour(2)->format('h:i:s') }} to {{ \Carbon\Carbon::parse($structure->str_vul_hour)->addHour(2)->format('h:i:s') }}</td>
