...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">
			{!! $at_username !!} - Activity Structure Report
			<small> - monthly report for {!! $month_year !!} for {!! $at_username !!}</small>
			<div class="pull-right">
				<ol class="breadcrumb">
					<li><a href="{{ route('dashboard') }}">@lang('app.home')</a></li>
					<li><a href="{{ route('activitytracker.metrics_index') }}">Activity Structure Report</a></li>
					<li><a href="{{ route('activitytracker.metrics_monthly_index', $month_year) }}">{!! $month_year !!}</a></li>
...
<div class="row col-md-12">
	<div class="panel panel-default">
		<div class="panel-heading">Activity Structure Report Monthly Report : {!! $at_username !!} for {!! $month_year !!}</div>
				...
				<table class="table" id="monthly-reports">
					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle">{!! $username->activity !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_meta_data_added !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_destroyed !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_has_fit !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_fitting_stored !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_has_no_ftting !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_reinforced_armor !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_reinforced_hull !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_anchoring !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_high_power !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_low_power !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_reinforced !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_unanchoring !!}</td>
							<td style="vertical-align: middle">{!! $username->structure_status_clear !!}</td>
