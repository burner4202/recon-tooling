		...
		<form method="GET" action="" accept-charset="UTF-8" id="universe-form " autocomplete="off">
			<div class="col-md-3">
				<div class="input-group custom-search-form">
					<input type="text" class="typeahead-universe form-control" name="search" value="{{ Input::get('search') }}" placeholder="Search System" meta name="csrf-token" content="{{csrf_token() }}">
...
<div class="col-md-12">
	...
	<div class="col-md-1">
		<div class="panel-heading"><a href="{{ route('solar.region', $region->ss_region_id) }}">{{ $region->ss_region_name }}</a></div>
	</div>
	@endforeach
</div>

<div class="col-md-6">
	{!! $universe->appends(\Request::except('universe'))->render() !!}
</div>

<div class="row col-md-12">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">New Eden Universe</div>
				...
				<div class="table-responsive top-border-table" id="srp-table-wrapper">
					...
					<table class="table" id="regions">
						<thead>
							...
							<th>@sortablelink('ss_region_name', 'Region')</th>
						...
						<tbody>
							...
							<tr>
								<td style="vertical-align: middle"><a href="{{ route('solar.system', $system->ss_system_id) }}">{{ $system->ss_system_name }}&nbsp;</a>
								...
								<td style="vertical-align: middle"><a href="{{ route('solar.constellation', $system->ss_constellation_id) }}">{{ $system->ss_constellation_name }}</a></td>
								<td style="vertical-align: middle"><a href="{{ route('solar.region', $system->ss_region_id) }}">{{ $system->ss_region_name }}</td>
...
<script>
	...
	$('input.typeahead-universe').typeahead({
