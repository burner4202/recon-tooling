...
@section('page-title', 'Enemy Alliance Standings | Index')
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">
			...
			<small> - for {{ $alliance->as_enemy_alliance_name }}</small>
			<div class="pull-right">
				<ol class="breadcrumb">
					<li><a href="{{ route('dashboard') }}">@lang('app.home')</a></li>
					<li><a href="{{ route('intelligence.index') }}">Intelligence Dashboard</a></li>
					<li><a href="{{ route('enemy_standings.index')}}">Enemy Alliance Standings</a></li>
					<li class="active">{{ $alliance->as_enemy_alliance_name }}</li>
				</ol>
			</div>
			...
			<div class="input-group custom-search-form">
				...
				<span class="input-group-btn">
					...
					@if (
						...
						<a href="{{ route('enemy_standings.view', $alliance->as_enemy_alliance_id) }}" class="btn btn-danger" system="button" >
...
<div class="col-md-12">
	...
	<div class="panel panel-default">
		<div class="panel-heading">Enemy Alliance Standings</div>
