				...
				<table class="table table-hover table-details">
					...
					<tbody>
						...
						<tr>
							...
							<td>{!! number_format($moon->moon_value_24_hour * 56,2) !!} isk</td>
						</tr>
						...
						<tr>
							<td>2020 Moon Composition</td>
							<td><a href="{{ route('moons.view_moon', $moon->moon_id)}}" target="_blank">Here</a></td>
						</tr>
