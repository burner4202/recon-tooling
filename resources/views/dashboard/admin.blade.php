...
<div class="alert alert-warning" role="alert">
    There are <b>{{ (count($tasks)) }}</b> outstanding tasks to be claimed. Click <a href="{{ route('taskmanager.outstanding')}}"><b>Here</b></a> to View the Task Manager.
</div>
@endif
            ...
            <div class="panel-body">
                ...
                <div class="list-group">
                    ...
                    <a href="{{ route('user.show', $user->id) }}" class="list-group-item">
                        ...
                        &nbsp; <strong>{{ $user->present()->username }}</strong>
