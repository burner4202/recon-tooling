...
@section('page-title', $region_name->ss_region_name)
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">
			{{ $region_name->ss_region_name }}
			<small> - </small>
			<div class="pull-right">
				<ol class="breadcrumb">
					<li><a href="{{ route('dashboard') }}">@lang('app.home')</a></li>
					<li><a href="{{ route('solar.universe') }}">Universe</a></li>
					<li class="active">{{ $region_name->ss_region_name }}</li>
				...
				<table class="table" id="regions">
					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle">{{ $system->ss_region_name }}</td>
